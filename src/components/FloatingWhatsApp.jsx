...
export default function FloatingWhatsApp(){
  return (
    <a
      ...
      className="fixed bottom-4 right-4 z-50 flex max-w-[calc(100vw-2rem)] items-center gap-3 rounded-full bg-[#25D366] px-4 py-3 text-black shadow-[0_18px_45px_rgba(37,211,102,0.32)] transition-transform duration-300 hover:-translate-y-1 sm:bottom-6 sm:right-6"
    >
      ...
      <span className="min-w-0">
        <span className="block text-xs font-semibold uppercase tracking-[0.18em]">WhatsApp</span>
        <span className="block truncate text-sm font-bold">{whatsappNumberIntl}</span>
      </span>
    </a>
  )
}
